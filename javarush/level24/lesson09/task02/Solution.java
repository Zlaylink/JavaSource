                ...
                else
                {
                    ...
                    if (date != 0)
                        ...
                        double change1 = stock1.containsKey("change") ?
                                (double) stock1.get("change") : ((double)stock1.get("last") - (double)stock1.get("open"));
                        double change2 = stock2.containsKey("change") ?
                                (double) stock2.get("change") : ((double)stock2.get("last") - (double)stock2.get("open"));

                        int changes = Double.compare(change2, change1);
                        if (changes != 0)
                            return changes;
                        else
                            return 0;
