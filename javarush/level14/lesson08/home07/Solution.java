...
public class Solution
{
    ...
    {
        for (Apartament kill : apartaments){
            if (kill instanceof Apt1Room)
                ((Apt1Room) kill).clean1Room();
            else if (kill instanceof Apt2Room)
                ((Apt2Room) kill).clean2Rooms();
            else ((Apt3Room) kill).clean3Rooms();
        }
    }
