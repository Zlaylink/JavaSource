...
public class Solution
{
    ...
    {
        Hen belarusianHen = HenFactory.getHen(Country.BELARUS);
        Hen russianHen = HenFactory.getHen(Country.RUSSIA);
        Hen moldovanHen = HenFactory.getHen(Country.MOLDOVA);
        Hen ukrainianHen = HenFactory.getHen(Country.UKRAINE);
